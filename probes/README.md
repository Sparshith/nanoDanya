...
python probes/cache_hiddens.py --model baseline/l12/reference --positions data/probes/positions_val_small.pt --out data/probes/hiddens_baseline_l12_val_small.pt
python probes/run.py --positions data/probes/positions_val_small.pt --hiddens data/probes/hiddens_baseline_l12_val_small.pt
```
